...
from bluetooth_for_linux import bluetooth_constants


def byte_array_to_hex_string(bytes_to_convert):
    hex_string = ""
...
def print_properties(props):
    # dbus.Dictionary({dbus.String('SupportedInstances'): dbus.Byte(4, variant_level=1),
    #   dbus.String('ActiveInstances'): dbus.Byte(1, variant_level=1)}, signature=dbus.Signature('sv'))
    for key in props:
